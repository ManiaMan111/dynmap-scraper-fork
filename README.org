...
A tool written in Python for downloading maps as images from MC server [[https://dev.bukkit.org/projects/dynmap][Dynmaps]]. This is a version forked from [[https://github.com/MithicSpirit/dynmap-scraper][MithicSpirit's]] orginal so that I can update and add new features.
